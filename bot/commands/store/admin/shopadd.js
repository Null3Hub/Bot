...
module.exports = {
  ...
  async execute(interaction) {
    ...
    AuditService.log(interaction.client, 'ADD_PRODUCT', {
      name,
      price,
      stock: keys.length,
      category,
    ...
    await interaction.editReply(`✅ Product **${name}** added with **${keys.length}** keys.`);
  }
};
